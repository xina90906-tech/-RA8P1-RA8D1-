...
#define VECTOR_NUMBER_GPT1_COUNTER_OVERFLOW ((IRQn_Type) 8) /* GPT1 COUNTER OVERFLOW (Overflow) */
#define GPT1_COUNTER_OVERFLOW_IRQn          ((IRQn_Type) 8) /* GPT1 COUNTER OVERFLOW (Overflow) */
#define VECTOR_NUMBER_GPT2_COUNTER_OVERFLOW ((IRQn_Type) 9) /* GPT2 COUNTER OVERFLOW (Overflow) */
#define GPT2_COUNTER_OVERFLOW_IRQn          ((IRQn_Type) 9) /* GPT2 COUNTER OVERFLOW (Overflow) */
...
#define VECTOR_NUMBER_IPC_IRQ0 ((IRQn_Type) 15) /* IPC IRQ0 (CPU Mutual Interrupt 0) */
#define IPC_IRQ0_IRQn          ((IRQn_Type) 15) /* IPC IRQ0 (CPU Mutual Interrupt 0) */
