...
#include "task.h"
#include "semphr.h"
extern void Wifi_thread_create(void);
extern TaskHandle_t Wifi_thread;
extern void Cloud_thread_create(void);
extern TaskHandle_t Cloud_thread;
extern void IPC_thread_create(void);
extern TaskHandle_t IPC_thread;
extern void servo_thread_create(void);
extern TaskHandle_t servo_thread;
