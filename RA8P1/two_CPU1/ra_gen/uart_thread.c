...
#include "uart_thread.h"
                ...
                static uint8_t uart_thread_stack[40960] BSP_PLACE_IN_SECTION(BSP_UNINIT_SECTION_PREFIX ".stack.thread") BSP_ALIGN_VARIABLE(BSP_STACK_ALIGNMENT);
                #else
                static uint8_t uart_thread_stack[40960] BSP_PLACE_IN_SECTION(BSP_UNINIT_SECTION_PREFIX ".stack.uart_thread") BSP_ALIGN_VARIABLE(BSP_STACK_ALIGNMENT);
                #endif
                #endif
...
#endif
			uart_thread_func, (const char*) "uart_thread", 40960 / 4, // In words, not bytes
